...
namespace SocialNetwork.BLL.Services
{
    public class MessageService
    {
        ...
        public PrettyMessage ConstructPrettyMessage(Message message, UserService userService, bool sender)
        {
            var user = sender ? userService.FindByEmail(message.SenderEmail) : 
                userService.FindByEmail(message.RecipientEmail);
            return new PrettyMessage
            {
                ...
                BitmapImage = ImageManager.GetPhoto(user.Photo)
            };
        }
    }
}
